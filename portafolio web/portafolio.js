...
function getData(){
  ...
  document.write('<link rel="stylesheet" href="css/foto.css">');
  document.write('<title>Gracias</title>');
  document.write('</head>');
  document.write('<body>');
  document.write('<div class="contenedor">');
  document.write('<div class="conImg">');
  document.write('<img src="./img/WhatsApp Image 2022-06-30 at 4.45.17 AM.jpeg" alt="">');
  document.write('</div>');
  document.write('<p class="frase4">Gracias por inscribirse, le<br/>saluda Cristhian Santos Nazareno</p>');
  ...
  document.write('<a href="contacto.html">Aceptar </a>');
  document.write('</div>');
  document.write('</div>');
  document.write('</body>');
  document.write('</html>');
